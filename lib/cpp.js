...
//                 cpp = code;
//             }
//             fs.writeFileSync('./tmp/cpp-Starchat.cpp', cpp);
//             var out = {
//                 stderr: 'N/A',
//                 stdout: 'N/A',
//                 code: cpp
//             }
//             var compile = "g++ ./tmp/cpp-Starchat.cpp -o ./tmp/cppStarchat.out"
//             var execute = "env -i ./tmp/cppStarchat.out"
//             try {
//                 await exec(compile)
//                 var child = execFile("env -i ./tmp/cppStarchat.out", [], {shell: true},
